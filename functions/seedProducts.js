/**
 * ShopStack - Quick Product Seeding Script
 * 
 * This script initializes products directly without requiring credentials.
 * Run after deploying functions: node seedProducts.js
 */

const admin = require('firebase-admin');

// Check if Firebase is already initialized (in deployed environment)
...
async function seedProducts() {
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log(`⚠️  Found ${existingSnapshot.size} existing products. Skipping seeding to avoid duplicates.`);
      console.log('If you want to reseed, delete products from Firestore console first.\n');
      return;
    }
